...
export function Skeleton({ className = '' }: SkeletonProps) {
  return (
    <div
      className={`animate-pulse rounded-none bg-white/[0.06] ${className}`}
    />
  )
}
...
export function MemberRowSkeleton() {
  return (
    <div className="flex items-center gap-3 px-4 py-3.5 border-b border-border-dark last:border-0">
      <Skeleton className="size-10 rounded-none flex-shrink-0" />
...
export function ServiceCardSkeleton() {
  return (
    <div className="rounded-none bg-surface-dark border border-border-dark p-4 space-y-3">
...
export function StatCardSkeleton() {
  return (
    <div className="rounded-none bg-surface-dark border border-border-dark p-4 space-y-2">
...
export function OrgCardSkeleton() {
  return (
    <div className="bg-surface-dark p-5 rounded-none border border-border-dark flex items-center gap-4">
      <Skeleton className="size-14 rounded-none flex-shrink-0" />
      <div className="flex-1 space-y-2">
