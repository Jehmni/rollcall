...
export default function Landing() {
  ...
  return (
    <div className="bg-transparent font-sans text-slate-100 antialiased min-h-screen selection:bg-primary/30 selection:text-white overflow-hidden relative">
      ...
      {/* Decorative subtle tonal shifts — absolute so they don't repaint on scroll */}
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-white/[0.02] blur-[120px] rounded-none mix-blend-screen pointer-events-none z-0" aria-hidden="true"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[30%] h-[40%] bg-white/[0.01] blur-[100px] rounded-none mix-blend-screen pointer-events-none z-0" aria-hidden="true"></div>
      ...
      <main className="flex flex-col min-h-screen pt-24 pb-24 sm:pb-0 relative z-10 w-full">
        ...
        <div className="fixed inset-0 w-full h-full z-0 pointer-events-none select-none" aria-hidden="true">
          <div className={`absolute inset-0 ${HERO_BG_CLASS} bg-cover bg-center opacity-[0.1] grayscale mix-blend-screen`}></div>
        ...
        <section className="relative z-10 flex flex-col items-center justify-center text-center px-4 pt-16 pb-20 max-w-5xl mx-auto w-full">
          <h1 className="font-display text-5xl sm:text-7xl font-black leading-[1.1] tracking-[0.02em] mb-8 drop-shadow-sm">
            Attendance{' '}
            <span className="text-white drop-shadow-md">Reimagined</span>
            <br />
        ...
        <section className="px-4 py-20 max-w-6xl mx-auto w-full z-10 relative" aria-labelledby="features-heading">
          <div className="text-center mb-16 relative">
            <h2 id="features-heading" className="font-display text-white text-4xl sm:text-5xl font-extrabold tracking-[0.05em] mb-4 drop-shadow-sm">Core Security &amp; Features</h2>
          ...
          <div className="max-w-4xl mx-auto relative">
            <div className="flex flex-col sm:flex-row items-end justify-between mb-10 gap-4">
              ...
              <div className="text-left sm:text-right" aria-live="polite" aria-atomic="true">
                <span className="text-white text-5xl font-black mb-1 block leading-none transition-all duration-300 ease-out">{presenceRate}%</span>
                <p className="text-slate-300 text-xs font-bold uppercase tracking-widest pl-1">Presence Rate</p>
              </div>
            </div>

            <div className="bg-white/[0.02] backdrop-blur-2xl rounded-none border border-white/10 p-8 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] relative overflow-hidden">
              <div className="absolute top-0 right-0 w-64 h-64 bg-primary/10 rounded-none blur-[80px] pointer-events-none" aria-hidden="true"></div>

              <div className="flex justify-between items-center mb-10 relative z-10">
                <div className="flex items-center gap-3 text-white">
                  <div className="p-2 bg-white/5 rounded-none border border-white/10" aria-hidden="true">
                ...
                <span className="bg-teal/20 border border-teal/30 text-teal text-xs px-3 py-1 rounded-none font-bold shadow-[0_0_10px_rgba(74,222,128,0.1)]">+12% vs LW</span>
              </div>
              ...
              >
                {chartBars.map((height, i) => (
                  <div key={i} className="relative w-full h-full flex items-end" aria-hidden="true">
                    <div
                      className={`w-full rounded-t-lg transition-all duration-500 ease-out ${i === activeIndex ? 'bg-primary from-primary to-primary-light shadow-[0_0_15px_rgba(168,85,247,0.4)] scale-y-[1.05]' : 'bg-white/10 hover:bg-primary'} origin-bottom`}
                      style={{ height: `${height}%` }}
                    ></div>
                  </div>
                ))}
        ...
        <section className="px-4 py-24 text-center max-w-6xl mx-auto w-full relative z-10" aria-labelledby="groups-heading">
          <div className="text-center mb-16 relative">
            <h2 id="groups-heading" className="font-display text-white text-4xl sm:text-5xl font-extrabold tracking-[0.05em] mb-4 drop-shadow-sm">Built for Every Elite Group</h2>
          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-12 md:gap-8">
            <div className="flex flex-col gap-6 max-w-xs">
              ...
              <div className="flex gap-4 pt-2">
                <span className="w-10 h-10 rounded-none bg-white/5 flex items-center justify-center text-slate-400 border border-white/5" title="Website" aria-label="Website (coming soon)"><span className="material-symbols-outlined text-xl" aria-hidden="true">public</span></span>
                <span className="w-10 h-10 rounded-none bg-white/5 flex items-center justify-center text-slate-400 border border-white/5" title="Email" aria-label="Email (coming soon)"><span className="material-symbols-outlined text-xl" aria-hidden="true">alternate_email</span></span>
                <span className="w-10 h-10 rounded-none bg-white/5 flex items-center justify-center text-slate-400 border border-white/5" title="Reviews" aria-label="Reviews (coming soon)"><span className="material-symbols-outlined text-xl" aria-hidden="true">share_reviews</span></span>
              </div>
            </div>
